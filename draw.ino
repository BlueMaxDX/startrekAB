...
void phaserAnimation( byte x, byte y ) {
  for (int i = 4; i > 0; i--) {
    updateMain();
    arduboy.drawRect(x * 7 + 5 - i * 2, y * 7 + 3 - i * 2, i * 4, i * 4, col(!ginv));
    arduboy.drawLine(x * 7 + 5 - i * 2, y * 7 + 3 - i * 2, x * 7 + 4 + i * 2, y * 7 + 3 - i * 2, col(!ginv));
    arduboy.drawLine(x * 7 + 5 - i * 2, y * 7 + 2 + i * 2, x * 7 + 4 + i * 2, y * 7 + 2 + i * 2, col(!ginv));
    arduboy.display();
    delay(SPEED * 5);
    arduboy.clear();
  }
